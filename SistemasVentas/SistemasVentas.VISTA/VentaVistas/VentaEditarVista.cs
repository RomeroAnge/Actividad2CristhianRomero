...
namespace SistemasVentas.VISTA.VentaVistas
{
    public partial class VentaEditarVista : Form
    {
        ...
        private void VentaEditarVista_Load(object sender, EventArgs e)
        {
            ...
            usuario = bssven.ObtenerUsuarioIdBss(p.IdVendedor);
            IdVendedorSeleccionada = p.IdVendedor;
            cliente = bssclie.ObtenerClienteIdBss(p.IdCliente);
            IdClienteSeleccionada = p.IdCliente;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (fr.ShowDialog() == DialogResult.OK)
            {
                ...
                IdClienteSeleccionada = cliente.IdCliente;
                textBox1.Text = cliente.IdCliente.ToString();
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (fr.ShowDialog() == DialogResult.OK)
            {
                ...
                IdVendedorSeleccionada = usuario.IdUsuario;
